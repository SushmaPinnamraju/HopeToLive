	...
	public String addVerifier(VerifierModel verifierModel) {
		try {
		     ...
		     if(iterator.hasNext()) {
			     ...
			     document.append("password", MD5.getMd5(verifierModel.getPassword()));
			     document.append("address", verifierModel.getAddress());
			     collection.insertOne(document);
				 Email.sendEmail("Verifier Registration", "Your Verifier Account Created Successfully.Your Login Credentails are Email: "+verifierModel.getEmail()+" Password:"+ verifierModel.getPassword(), verifierModel.getEmail());
