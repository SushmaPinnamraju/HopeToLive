...
public static final String REQUESTED_CANCELLED_BY_SEEKER="Requested Cancelled by Seeker";

public static final String REQUESTED_REJECTED_BY_HOSPITAL="Requested Rejected by Hospital";
public static final String REQUESTED_APPORVED_BY_HOSPITAL="Requested Apporved by Hospital";
public static final String REQUESTED_CANCELLED_BY_HOSPITAL="Requested Cancelled by Hospital";

public static final String REQUESTED_REJECTED_BY_ADMIN="Requested Rejected by Admin";
public static final String REQUESTED_CANCELLED_BY_ADMIN="Requested Cancelled by Admin";
public static final String REQUESTED_APPORVED_BY_ADMIN="Requested Apporved by Admin";

public static final String REQUESTED_REJECTED_BY_VERIFIER="Requested Rejected by Verifier";
public static final String REQUESTED_APPORVED_BY_VERIFIER="Requested Apporved by Verifier";
